<script>
    import { BIconBatteryFull, BIconBagFill } from 'bootstrap-icons-vue';
...
<template>
    <div>
        ...
        <p>Here is a Bootstrap Icon: <b-icon-battery-full style="color: red" /><b-icon-bag-fill/></p>
        ...
        <p>Second Value: {{ Math.floor(ageRange[1]) }}</p>
    </div>
</template>